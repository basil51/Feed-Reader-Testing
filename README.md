...
- Click to check github hosted version [online](https://basil51.github.io/Feed-Reader-Testing/index.html).
...
1. I took the JavaScript Testing course.
...
17. No test was dependent on the results of another.
18. Callbacks used to ensure that feeds are loaded before they are tested.
19. Implement error handling for undefined variables and out-of-bound array access.
20. When complete - all of your tests should pass.
21. Write a README file -this file- detailing all steps required to successfully run the application.re checking for.
